...
down_revision: Union[str, None] = 'a6acff34fab8'
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('message_id', 'file_id', name=op.f('uq_message_attachments_message_id'))
    )
    ...
    sa.ForeignKeyConstraint(['tool_id'], ['tool_definitions.id'], name=op.f('fk_tool_executions_tool_id_tool_definitions'), ondelete='CASCADE'),
